...
class TracksList extends StatelessWidget {
  ...
  DataTable buildDataTable(BuildContext context) {
    return DataTable(
      ...
      rows: tracks.map((e) {
        ...
        final textStyle = buildTextStyle2(selected, context);
        return buildDataRow(e, textStyle, selected, context);
      }).toList(),
    );
  }

  DataRow buildDataRow(
      Song e, TextStyle textStyle, bool selected, BuildContext context) {
    return DataRow(
      cells: [
        DataCell(
  ...
  TextStyle buildTextStyle2(bool selected, BuildContext context) {
    return TextStyle(
        color: selected
